...
namespace MyScript.InteractiveInk
{
    ...
    public sealed partial class App
    {
        ...
        public Engine Engine =>
            _engine ??= OnCreateEngine((byte[])(Array)MyCertificate.Bytes);
        ...
        private static Engine OnCreateEngine(byte[] certificate)
        {
            ...
            configuration.SetStringArray("configuration-manager.search-path",
                new[] {Path.Combine(installedLocation.Path, "Assets", "conf")});
            configuration.SetString("content-package.temp-folder", Path.Combine(installedLocation.Path, "temp"));
#if DEBUG
