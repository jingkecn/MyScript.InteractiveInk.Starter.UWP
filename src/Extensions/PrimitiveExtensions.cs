...
namespace MyScript.InteractiveInk.Extensions
{
    public static partial class PrimitiveExtensions
    {
        ...
        public static Rect FromPixelToMillimeter(this Rect source, float dpi)
        {
            return source.FromPixelToMillimeter(dpi, dpi);
        }

        public static Rect FromPixelToMillimeter(this Rect source, Vector2 dpi)
        {
            return source.FromPixelToMillimeter(dpi.X, dpi.Y);
        }
        ...
        public static Rect FromMillimeterToPixel(this Rect source, float dpi)
        {
            return source.FromMillimeterToPixel(dpi, dpi);
        }

        public static Rect FromMillimeterToPixel(this Rect source, Vector2 dpi)
        {
            return source.FromMillimeterToPixel(dpi.X, dpi.Y);
        }
    }
